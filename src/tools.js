export const TOOLS = [
  ...
  },
  {
    ...
    desc: 'Realistic AI avatars with dubbing in 140+ languages. No camera or studio needed — create professional presenter videos in minutes.',
    details: {
      what: 'AI video generation platform specialising in photorealistic avatar videos, widely used for corporate training, marketing, and presenter-style content. One of the most established platforms in the category, with a large curated avatar library and strong enterprise compliance track record.',
      how: 'Choose from 240+ stock avatars trained on real, consenting actors. Write your script, select a voice, and Synthesia generates the avatar video with accurate lip sync. AI Dubbing re-renders existing videos into other languages with matching lip sync. Custom avatars are available as a separate add-on on most plans.',
      features: ['240+ photorealistic stock avatars (diverse ages, ethnicities, styles)', 'AI Dubbing with lip sync in 140+ languages', 'Voice library with natural-sounding narration', 'Custom avatar add-on for your own digital twin', 'SOC 2 Type II and ISO 27001 compliance', 'Structured templates for repeatable production', 'API access on higher plans'],
      trial: 'Time-limited free trial. Paid plans from around $18-29/month depending on billing cycle.',
      platform: 'Web-based (browser), API',
      bestFor: 'Faceless creators wanting a polished, professional on-screen presenter, and creators looking to expand into international audiences via dubbing.',
    },
    commission: '25% recurring for 12 months', commissionNum: 7.25, cookie: '60 days',
    affiliateUrl: 'https://www.synthesia.io/?via=phillip-bates',
    tags: ['avatar','voiceover'], types: ['faceless','tutorial'], minExp: 'new', hasTrial: true,
  },
